...
const IndexPage = () => (
  <Layout>
    ...
    <p className="text-center">
      ...
      <h2 className="text-center">Mjölumban flyger fram. När han inte kan flyga fram så surrar han fram..</h2>
      <p>
      ...
      <ul>
          <li>Mjölumba</li>
          <li>Fruktmjölumban</li>
          <li>jordmjölumba</li>
          <li>lundmjölumba</li>
          <li>Mjölumbahonorna</li>
        </ul></p>
    </main>
  </section>
  </Layout>
